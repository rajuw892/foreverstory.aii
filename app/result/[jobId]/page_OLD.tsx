        ...
        >
          {!isPaid ? (
            <>
              ...
              {/* Premium Benefits */}
              <GlassCard className="p-4 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20">
                <h4 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Premium includes:</h4>
                <div className="grid grid-cols-2 gap-2 text-sm">
                  <span className="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                    <Check className="w-4 h-4 text-green-500 shrink-0" /> 1080p HD Video
                  </span>
                  <span className="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                    <Check className="w-4 h-4 text-green-500 shrink-0" /> No Watermark
                  </span>
                  <span className="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                    <Check className="w-4 h-4 text-green-500 shrink-0" /> 4K Upscaled Version
                  </span>
                  <span className="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                    <Check className="w-4 h-4 text-green-500 shrink-0" /> Photos as ZIP
                  </span>
                  <span className="flex items-center gap-2 text-gray-600 dark:text-gray-400 col-span-2">
                    <Check className="w-4 h-4 text-green-500 shrink-0" /> Editable script for re-render
                  </span>
                </div>
              </GlassCard>
              ...
              <div className="text-center py-2">
                <p className="text-xs text-gray-400 mb-2">Free version: 720p with small watermark</p>
              </div>
              ...
              >
                ...
                Download Free Preview (720p, watermarked)
              </Button>
            </>
          ) : (
            <>
